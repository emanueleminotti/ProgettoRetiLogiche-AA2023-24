...
\subsubsection{Macchina a stati}
  ...
  \par Di seguito vengono elencati gli stati della macchina con le relative uscite. Gli stati $S2$, $S3$ ed $S5$ sono considerati stati \textit{idle} e non producono alcuna uscita. Tuttavia, si è rivelato necessario aggiungerli in fase di progettazione per garantire la corretta sincronizzazione dei moduli tra loro e con il clock.
=======
...
\subsubsection{Macchina a stati}
  ...
  \end{itemize}
>>>>>>> f13943feb7500be4782b7ccf2c29030b4c146cc7
  \begin{figure}[H]
